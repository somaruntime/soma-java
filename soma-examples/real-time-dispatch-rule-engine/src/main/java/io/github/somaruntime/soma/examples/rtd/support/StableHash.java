package io.github.somaruntime.soma.examples.rtd.support;

import java.nio.charset.StandardCharsets;
import java.security.MessageDigest;
import java.security.NoSuchAlgorithmException;

/** Detached input、command 与 Result 使用的稳定 SHA-256 编码。 */
  ...
  public StableHash() {
    try {
      ...
      throw new IllegalStateException(
          "SHA-256 is required by Java 8", impossible);
    }
  }

  public StableHash addString(String value) {
    if (value == null) return addInt(-1);
