package com.hgtech.soma.examples.rtd.benchmark;
...
/** 与 RTD scenario generation 独立的 benchmark measurement 配置。 */
public final class BenchmarkOptions {
  ...
  public static BenchmarkOptions load(String selector)
      throws IOException {
  ...
  private static InputStream open(String selector)
    ...
    if (input == null) {
      throw new IOException(
          "benchmark options not found: " + selector);
    }
    return input;
  }

  private static int intValue(
      Properties values, String key) {
    try {
