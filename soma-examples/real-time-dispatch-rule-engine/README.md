...
受众：评估或运行实时派工规则引擎参考应用的 Java 开发者
...
- [Blueprint](../../project/modules/soma-examples/real-time-dispatch-rule-engine/blueprint.md)：从使用者视角理解配置、场景、规则执行和结果；
- [Design](../../project/modules/soma-examples/real-time-dispatch-rule-engine/design.md)：领域分层、DataFlow、提交、资源与失败边界；
- [Validation](../../project/modules/soma-examples/real-time-dispatch-rule-engine/validation.md)：reference differential、并行、规模和性能证据。
