...
类型：Product Projection / Example

状态：当前

Owner：grassing-individual-simulation

受众：评估或运行个体生态仿真参考应用的 Java 开发者

输入事实源：application POM、production source、versioned config 与 canonical validation
...
- [Blueprint](../../project/modules/soma-examples/grassing-individual-simulation/blueprint.md)：从使用者视角理解配置、场景、会话和 tick journey；
- [Design](../../project/modules/soma-examples/grassing-individual-simulation/design.md)：应用分层、领域系统、runtime projection、生命周期与失败边界；
- [Validation](../../project/modules/soma-examples/grassing-individual-simulation/validation.md)：source-set、架构 Gate、AoS oracle、长期运行和多 fork 证据。
