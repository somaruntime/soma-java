...
非事实范围：Design 语义、测试结果和 release readiness
...
| package/security | [`package-smoke.sh`](../../scripts/package-smoke.sh)、[`source-package-smoke.sh`](../../scripts/source-package-smoke.sh)及 security/release scripts | binary/source distribution boundary |
