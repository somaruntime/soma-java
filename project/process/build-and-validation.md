...
| package/release candidate | binary/source package、security、reproducibility、external consumer 及获批 release Gate |
...
- binary/source package、security、application Full和runtime-scale qualification仍由现有独立
  手动入口拥有，不成为Full的隐式工作。
