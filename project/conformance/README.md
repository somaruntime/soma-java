...
Physical Execution Engine M2 `FORMALLY_PROMOTED / IMPLEMENTATION_AUTHORIZED / P1-P3_COMPLETED / P4_ACTIVE`
...
Active implementation slice   M2_P4
G1                             PASS
G2                             PASS
G3                             PASS
G4                             PASS
...
Active bounded topic          PHYSICAL_EXECUTION_ENGINE_M2 / FORMALLY_PROMOTED /
                              IMPLEMENTATION_AUTHORIZED / P1-P3_COMPLETED / P4_ACTIVE
...
- [Physical Execution Engine M2 P2资格](physical-execution-engine-m2-p2-qualification.md)：Row、Field、
  Mapped、Primitive stateless typed Segment、callback barrier、shape transition与P2 evidence Owner；
- [Physical Execution Engine M2 P3资格](physical-execution-engine-m2-p3-qualification.md)：Unary finite
