...
事实范围：当前 V1 release、性能、项目组织、support matrix 与 G6 readiness

非事实范围：Blueprint、Design、代码实现事实和历史治理过程

最后审查日期：2026-07-30

`project/reports/` 只保留当前决策所需的综合报告与不可替代 release evidence。已经完成的
...
[Design](../design/README.md) 与
[Implementation Map](../implementation-map/README.md)进入。
...
- [项目组织治理](project-organization-governance-report.md)：事实体系、角色投影、
  模块集中、精简源码交付、角色旅程与 cutover 验证；
