...
`FORMALLY_PROMOTED / IMPLEMENTATION_AUTHORIZED / P1-P3_COMPLETED / P4_ACTIVE`；publication `NOT_AUTHORIZED`
...
- [Physical Execution Engine M2正式晋升与实施准入](conformance/v1-physical-execution-engine-m2-promotion-readiness.md)
  ...
  [P3资格](conformance/physical-execution-engine-m2-p3-qualification.md)已`PASS`，当前P4为唯一active slice；
