...
implementation authorization `GRANTED`；I0 `COMPLETE`；I1 `COMPLETE (I1_SCOPE)`；I2 `COMPLETE (I2_SCOPE)`；I3-I8 `NOT_STARTED`
...
- I0 为`COMPLETE`，I1 已完成其 bounded primitive keyed Table vertical slice，I2 已完成其
  bounded scalar type/storage breadth slice；I3-I8 仍为`NOT_STARTED`；当前没有 active
  implementation slice，下一项从 I3 开始。
...
当前 active checkout 已有 I1 与 I2 范围的 qualified generated consumer API 与 primitive/scalar
Table runtime；仍没有 I3+ breadth、benchmark、Example、CI/release workflow、package 或
...
| Engineering | `project/engineering/`；I0/I1/I2 bounded slice complete，I3-I8 not started |
| Conformance | `project/conformance/`；G1 PASS，G2-G5 I2 scope pass，G10 in progress |
...
I0/I1/I2 exit evidence已经闭合；下一项从I3开始。当前授权同时允许每个 slice 证据闭合后的干净
