...
`FORMALLY_PROMOTED / IMPLEMENTATION_AUTHORIZED / P1-P4_COMPLETED / P5_ACTIVE`；publication `NOT_AUTHORIZED`
...
- [Physical Execution Engine M2正式晋升与实施准入](conformance/v1-physical-execution-engine-m2-promotion-readiness.md)
  ...
  [P4资格](conformance/physical-execution-engine-m2-p4-qualification.md)已`PASS`，当前P5为唯一active slice；
...
正式Owner接管，Product Owner已授权P1-P6实施，P1-P4已完成，当前P5为唯一active slice。
