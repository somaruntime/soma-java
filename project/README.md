...
implementation authorization `GRANTED`；I0 `COMPLETE`；I1 `COMPLETE (I1_SCOPE)`；I2 `COMPLETE (I2_SCOPE)`；I3 `COMPLETE (I3_SCOPE)`；I4 `COMPLETE (I4_SCOPE)`；I5 `COMPLETE (I5_SCOPE)`；I6-I8 `NOT_STARTED`
...
- I0 为`COMPLETE`，I1 已完成其 bounded primitive keyed Table vertical slice，I2 已完成其
  ...
  I4 已完成其 bounded point-remove slice，I5 已完成其 bounded integer-key GroupBy slice；I6-I8
  仍为`NOT_STARTED`；当前没有 active implementation slice，下一项从 I6 开始。
...
当前 active checkout 已有 I1、I2、I3、I4 与 I5 范围的 qualified generated consumer API 与 primitive/scalar
Table runtime；仍没有 I6+ breadth、benchmark、Example、CI/release workflow、package 或
...
| Engineering | `project/engineering/`；I0/I1/I2/I3/I4/I5 bounded slice complete，I6-I8 not started |
| Conformance | `project/conformance/`；G1 PASS，G2-G6 I5 scope pass，G10 in progress |
...
I0/I1/I2/I3/I4/I5 exit evidence已经闭合；下一项从I6开始。当前授权同时允许每个 slice 证据闭合后的干净
