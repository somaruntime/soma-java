...
require_once docs/design/compatibility-security-and-versioning.md '当前选择的发布渠道为 private GitHub source repository'
require_once docs/engineering/release-governance.md 'artifact distribution provenance。未选择的 profile 保持 `not-selected`，不能写成'
