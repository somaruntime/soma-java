...
require_once docs/engineering/build-and-validation.md 'V1 compiler/runtime validation 使用 Amazon Corretto 8.502.07.1 full JDK 8'
require_once docs/engineering/documentation-governance.md '重大长期设计变化先进入 Temporary'
require_once docs/conformance/known-gaps.md '| `CF-006` | Release readiness |'
require_once docs/conformance/known-gaps.md '| `CF-016` | Corretto runtime-scale qualification已闭合 |'
require_once docs/conformance/known-gaps.md '| `CF-018` | Logical/physical production cutover已闭合 |'
