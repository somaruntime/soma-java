...
scheduler_default_baseline=$scheduler_baseline_dir/performance-baseline-default-zulu8-macos-aarch64-v4.json
scheduler_large_baseline=$scheduler_baseline_dir/performance-baseline-large-zulu8-macos-aarch64-v3.json
scheduler_long_run_baseline=$scheduler_baseline_dir/performance-baseline-long-run-zulu8-macos-aarch64-v3.json
