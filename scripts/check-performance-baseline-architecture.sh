...
simulation_default_baseline=$simulation_baseline_dir/performance-baseline-default-corretto8-macos-aarch64-v6.json
simulation_large_baseline=$simulation_baseline_dir/performance-baseline-large-corretto8-macos-aarch64-v5.json
simulation_long_run_baseline=$simulation_baseline_dir/performance-baseline-long-run-corretto8-macos-aarch64-v5.json
