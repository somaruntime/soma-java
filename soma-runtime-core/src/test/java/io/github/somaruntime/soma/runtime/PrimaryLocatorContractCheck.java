...
import io.github.somaruntime.soma.runtime.generated.HashLongKeySpace;
...
/** Primitive primary-locator identity、rehash 与 overflow 能力契约。 */
public final class PrimaryLocatorContractCheck {
    private PrimaryLocatorContractCheck() {
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("primary-locator-contract: ok");
    }
