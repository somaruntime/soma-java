...
final class DenseAuxiliarySourceEmitter {
    ...
    String batchSource(TableSpec table) {
        ...
        SourceBuilder out = new SourceBuilder(header());
        out.append("import io.github.somaruntime.soma.runtime.generated.RuntimeFailures;\n")
    ...
    String keyTraversalSource(TableSpec table) {
        ...
        SourceBuilder out = new SourceBuilder(header());
        out.append("import io.github.somaruntime.soma.runtime.MaterializationBudget;\n")
                .append("import io.github.somaruntime.soma.runtime.SomaRuntimeException;\n")
                ...
                .append("  public void forEach(Consumer<").append(key.boxed).append("> consumer){if(consumer==null)throw new NullPointerException(\"consumer\");start(\"keys.forEach\");long scanned=0L;try{int size=table.size();for(int row=0;row<size;row++){scanned++;table.beginCallback(\"keys.forEach.consumer\");try{consumer.accept(").append(key.boxValue("table." + key.javaName + "Value(row)")).append(");}catch(SomaRuntimeException failure){throw failure;}catch(RuntimeException callback){throw RuntimeFailures.callbackFailed(").append(q(table.logicalName)).append(",\"keys.forEach\",\"consumer\",callback);}finally{table.endCallback(\"keys.forEach.consumer\");}}table.endSuccess(\"keys.forEach\",scanned,scanned,0L);}catch(SomaRuntimeException failure){table.endFailure(\"keys.forEach\",scanned,scanned,failure);throw failure;}catch(Error failure){table.abort(\"keys.forEach\");throw failure;}}\n")
    ...
    String scanSource(TableSpec table) {
        ...
        SourceBuilder out = new SourceBuilder(header());
        out.append("import io.github.somaruntime.soma.runtime.RemoveResult;\n")
                ...
                .append("import io.github.somaruntime.soma.runtime.generated.GeneratedScanEvaluation;\n")
                .append("import io.github.somaruntime.soma.runtime.generated.GeneratedScanPlan;\n")
                .append("import io.github.somaruntime.soma.runtime.generated.RuntimeFailures;\n")
        ...
        out
                ...
                .append("  private boolean matchTerminal(Predicate value,boolean any){if(value==null)throw new NullPointerException(\"predicate\");String op=any?\"scan.anyMatch\":\"scan.noneMatch\",callback=any?\"scan.anyMatch.predicate\":\"scan.noneMatch.predicate\";start(op);long reached=0L,scanned=0L;GeneratedScanEvaluation e=null;try{Cursor c=new Cursor(table());if(!hasSort()){int initial=plan.size();for(int position=0;position<initial&&!limitReached(0,plan.stageCount());position++){int index=plan.rowAt(position);scanned++;if(matches(index,c,0,plan.stageCount())){reached++;if(test(value,c,index,op,callback)){table().endSuccess(op,scanned,reached,0L);return true;}}}table().endSuccess(op,scanned,reached,0L);return false;}e=new GeneratedScanEvaluation();select(e,terminalMaximum());scanned=e.selectionScanned;for(int i=0;i<e.length;i++){reached++;if(test(value,c,e.indexes[i],op,callback)){table().endSuccess(op,scanned,reached,0L);return true;}}table().endSuccess(op,scanned,reached,0L);return false;}catch(SomaRuntimeException f){table().endFailure(op,e==null?scanned:e.attemptedScanned,e==null?reached:e.attemptedMatched,f);throw f;}catch(RuntimeException f){table().abort(op);throw f;}catch(Error f){table().abort(op);throw f;}finally{finish();}}\n")
                .append("  public void forEach(Consumer value){if(value==null)throw new NullPointerException(\"consumer\");start(\"scan.forEach\");long reached=0L,scanned=0L;GeneratedScanEvaluation e=null;try{Cursor c=new Cursor(table());if(!hasSort()){int initial=plan.size();for(int position=0;position<initial&&!limitReached(0,plan.stageCount());position++){int index=plan.rowAt(position);scanned++;if(!matches(index,c,0,plan.stageCount()))continue;reached++;c.open(index);table().beginCallback(\"scan.forEach.consumer\");try{value.accept(c);}catch(SomaRuntimeException failure){throw failure;}catch(RuntimeException callback){throw RuntimeFailures.callbackFailed(").append(q(table.logicalName)).append(",\"scan.forEach\",\"consumer\",callback);}finally{table().endCallback(\"scan.forEach.consumer\");c.close();}}table().endSuccess(\"scan.forEach\",scanned,reached,0L);return;}e=new GeneratedScanEvaluation();select(e,terminalMaximum());scanned=e.selectionScanned;for(int i=0;i<e.length;i++){reached++;c.open(e.indexes[i]);table().beginCallback(\"scan.forEach.consumer\");try{value.accept(c);}catch(SomaRuntimeException failure){throw failure;}catch(RuntimeException callback){throw RuntimeFailures.callbackFailed(").append(q(table.logicalName)).append(",\"scan.forEach\",\"consumer\",callback);}finally{table().endCallback(\"scan.forEach.consumer\");c.close();}}table().endSuccess(\"scan.forEach\",scanned,reached,0L);}catch(SomaRuntimeException f){table().endFailure(\"scan.forEach\",e==null?scanned:e.attemptedScanned,e==null?reached:e.attemptedMatched,f);throw f;}catch(RuntimeException f){table().abort(\"scan.forEach\");throw f;}catch(Error f){table().abort(\"scan.forEach\");throw f;}finally{finish();}}\n")
                .append("  public int findIndex(){start(\"scan.findIndex\");GeneratedScanEvaluation e=new GeneratedScanEvaluation();try{select(e,1);int result=e.length==0?-1:e.indexes[0];table().endSuccess(\"scan.findIndex\",e.selectionScanned,e.length,0L);return result;}catch(SomaRuntimeException f){table().endFailure(\"scan.findIndex\",e.attemptedScanned,e.attemptedMatched,f);throw f;}catch(RuntimeException f){table().abort(\"scan.findIndex\");throw f;}catch(Error f){table().abort(\"scan.findIndex\");throw f;}finally{finish();}}\n")
                .append("  public int requireIndex(){start(\"scan.requireIndex\");GeneratedScanEvaluation e=new GeneratedScanEvaluation();try{select(e,1);if(e.length==0)throw RuntimeFailures.emptyResult(sourcePath(),\"scan.requireIndex\");int result=e.indexes[0];table().endSuccess(\"scan.requireIndex\",e.selectionScanned,1L,0L);return result;}catch(SomaRuntimeException f){table().endFailure(\"scan.requireIndex\",e.attemptedScanned,e.attemptedMatched,f);throw f;}catch(RuntimeException f){table().abort(\"scan.requireIndex\");throw f;}catch(Error f){table().abort(\"scan.requireIndex\");throw f;}finally{finish();}}\n")
                ...
                .append("  private Optional<").append(table.carrierType).append("> findFirstStarted(MaterializationBudget budget){GeneratedScanEvaluation e=new GeneratedScanEvaluation();try{budget=materializationBudget(budget);select(e,1);Optional<").append(table.carrierType).append("> result=table().materializeOptionalRow(e.length==0?-1:e.indexes[0],budget,\"scan.findFirst\",true);table().endSuccess(\"scan.findFirst\",e.selectionScanned,e.length,0L);return result;}catch(SomaRuntimeException f){table().endFailure(\"scan.findFirst\",e.attemptedScanned,e.attemptedMatched,f);throw f;}catch(RuntimeException f){table().abort(\"scan.findFirst\");throw f;}catch(Error f){table().abort(\"scan.findFirst\");throw f;}finally{finish();}}\n")
                ...
                .append("  private ").append(table.carrierType).append(" firstOrThrowStarted(MaterializationBudget budget){GeneratedScanEvaluation e=new GeneratedScanEvaluation();try{budget=materializationBudget(budget);select(e,1);").append(table.carrierType).append(" result=table().materializeRequiredRow(e.length==0?-1:e.indexes[0],budget,\"scan.firstOrThrow\",true,sourcePath());table().endSuccess(\"scan.firstOrThrow\",e.selectionScanned,1L,0L);return result;}catch(SomaRuntimeException f){table().endFailure(\"scan.firstOrThrow\",e.attemptedScanned,e.attemptedMatched,f);throw f;}catch(RuntimeException f){table().abort(\"scan.firstOrThrow\");throw f;}catch(Error f){table().abort(\"scan.firstOrThrow\");throw f;}finally{finish();}}\n")
                ...
                .append("  private List<").append(table.carrierType).append("> fetchAllStarted(MaterializationBudget budget){GeneratedScanEvaluation e=new GeneratedScanEvaluation();try{budget=materializationBudget(budget);select(e,terminalMaximum());List<").append(table.carrierType).append("> result=table().materializeRows(e.indexes,e.length,budget,\"scan.fetchAll\",true);table().endSuccess(\"scan.fetchAll\",e.selectionScanned,e.length,0L);return result;}catch(SomaRuntimeException f){table().endFailure(\"scan.fetchAll\",e.attemptedScanned,e.attemptedMatched,f);throw f;}catch(RuntimeException f){table().abort(\"scan.fetchAll\");throw f;}catch(Error f){table().abort(\"scan.fetchAll\");throw f;}finally{finish();}}\n")
                .append("  private MaterializationBudget materializationBudget(MaterializationBudget budget){return budget==null?table().runtimePlan().defaultMaterializationBudget():budget;}\n")
                .append("  public IndexSnapshot indexSnapshot(){start(\"scan.indexSnapshot\");GeneratedScanEvaluation e=new GeneratedScanEvaluation();try{select(e,terminalMaximum());IndexSnapshot result=table().indexSnapshot(e.indexes,e.length);table().endSuccess(\"scan.indexSnapshot\",e.selectionScanned,e.length,0L);return result;}catch(SomaRuntimeException f){table().endFailure(\"scan.indexSnapshot\",e.attemptedScanned,e.attemptedMatched,f);throw f;}catch(RuntimeException f){table().abort(\"scan.indexSnapshot\");throw f;}catch(Error f){table().abort(\"scan.indexSnapshot\");throw f;}finally{finish();}}\n")
                .append("  public UpdateResult update(Updater value){if(value==null)throw new NullPointerException(\"updater\");startMutation(\"scan.update\");long reached=0L;boolean selected=false;GeneratedScanEvaluation e=new GeneratedScanEvaluation();try{select(e,terminalMaximum());selected=true;table().prepareUpdateScratch(e.length);table().loadUpdateScratch(e.indexes,e.length);MutableCursor c=new MutableCursor(table());for(int i=0;i<e.length;i++){reached++;c.open(i,e.indexes[i]);table().beginCallback(\"scan.update.updater\");try{value.update(c);}catch(SomaRuntimeException failure){throw failure;}catch(RuntimeException callback){throw RuntimeFailures.callbackFailed(").append(q(table.logicalName)).append(",\"scan.update\",\"updater\",callback);}finally{table().endCallback(\"scan.update.updater\");c.close();}}long changed=table().publishUpdate(e.indexes,e.length);table().endSuccess(\"scan.update\",e.selectionScanned,e.length,changed);return table().updateResult(e.selectionScanned,e.length,changed);}catch(SomaRuntimeException f){table().endFailure(\"scan.update\",selected?e.selectionScanned:e.attemptedScanned,reached==0L&&!selected?e.attemptedMatched:reached,f);throw f;}catch(RuntimeException f){table().abort(\"scan.update\");throw f;}catch(Error f){table().abort(\"scan.update\");throw f;}finally{if(selected)table().clearUpdateScratch(e.length);finish();}}\n\n")
                .append("  public RemoveResult remove(){startMutation(\"scan.remove\");boolean selected=false;GeneratedScanEvaluation e=new GeneratedScanEvaluation();try{select(e,terminalMaximum());selected=true;RemoveResult result=table().removeSelected(e.indexes,e.length,e.selectionScanned,\"scan.remove\");table().endSuccess(\"scan.remove\",e.selectionScanned,e.length,e.length);return result;}catch(SomaRuntimeException f){table().endFailure(\"scan.remove\",selected?e.selectionScanned:e.attemptedScanned,selected?e.length:e.attemptedMatched,f);throw f;}catch(RuntimeException f){table().abort(\"scan.remove\");throw f;}catch(Error f){table().abort(\"scan.remove\");throw f;}finally{finish();}}\n\n")
    ...
    private void appendScanSources(SourceBuilder out, TableSpec table) {
        ...
        for (int selectorIndex = 0; selectorIndex < table.selectors.size(); selectorIndex++) {
            ...
            out.append(");row=group<0?-1:table.selector").append(selectorIndex)
                    ...
                    .append(" table=table();if(position!=nextPosition||row<0)throw table.internalInvariant(\"exact_index_source_sequence\",")
