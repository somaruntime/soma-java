...
final class I2ApiRenderer {
    ...
    private static void renderSelection(StringBuilder source, SchemaModel.Type table) {
        ...
        source.append("        public <R> MappedStream<R> map(Function<? super View, ? extends R> mapper) { if (mapper == null) throw io.github.somaruntime.soma.internal.SomaRuntimeAccess.failure(io.github.somaruntime.soma.SomaFailureCode.INVALID_ARGUMENT, io.github.somaruntime.soma.SomaOperation.QUERY, \"mapper must not be null\", null); claim(); return new MappedStream<R>(this, mapper); }\n");
        source.append("        public LongMappedStream mapToLong(ToLongFunction<? super View> mapper) { if (mapper == null) throw io.github.somaruntime.soma.internal.SomaRuntimeAccess.failure(io.github.somaruntime.soma.SomaFailureCode.INVALID_ARGUMENT, io.github.somaruntime.soma.SomaOperation.QUERY, \"mapper must not be null\", null); claim(); return new LongMappedStream(this, mapper); }\n");
