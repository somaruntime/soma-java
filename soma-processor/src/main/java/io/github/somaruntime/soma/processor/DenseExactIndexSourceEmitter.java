...
import static io.github.somaruntime.soma.processor.DenseSelectorCodegenModel.SelectorParameter;
import static io.github.somaruntime.soma.processor.DenseSelectorCodegenModel.selectorParameterLeafCount;
...
import static io.github.somaruntime.soma.processor.DenseSelectorSourceSupport.appendExactIndexReplacementRuntime;
import static io.github.somaruntime.soma.processor.DenseSelectorSourceSupport.appendNoMutableSelectorChange;
import static io.github.somaruntime.soma.processor.DenseSelectorSourceSupport.appendSelectorArguments;
import static io.github.somaruntime.soma.processor.DenseSelectorSourceSupport.appendSelectorBatchEquality;
import static io.github.somaruntime.soma.processor.DenseSelectorSourceSupport.appendSelectorChangeRuntime;
import static io.github.somaruntime.soma.processor.DenseSelectorSourceSupport.appendSelectorComparison;
import static io.github.somaruntime.soma.processor.DenseSelectorSourceSupport.appendSelectorHash;
...
import static io.github.somaruntime.soma.processor.DenseSelectorSourceSupport.selectorBinding;
import static io.github.somaruntime.soma.processor.DenseSelectorSourceSupport.selectorCanChange;
import static io.github.somaruntime.soma.processor.DenseSelectorSourceSupport.selectorHashBits;
import static io.github.somaruntime.soma.processor.DenseSelectorSourceSupport.selectorMethodName;
import static io.github.somaruntime.soma.processor.DenseSelectorSourceSupport.selectorMutatorValueOrLive;
import static io.github.somaruntime.soma.processor.DenseSelectorSourceSupport.selectorStorageValue;
