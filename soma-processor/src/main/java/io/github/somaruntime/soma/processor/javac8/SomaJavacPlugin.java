package io.github.somaruntime.soma.processor.javac8;
...
public final class SomaJavacPlugin implements Plugin {
    ...
    private static final String SOMA_VALUE = "io.github.somaruntime.soma.annotation.SomaValue";
    private static final String SOMA_FIELD = "io.github.somaruntime.soma.annotation.SomaField";
    private static final String SOMA_IGNORE = "io.github.somaruntime.soma.annotation.SomaIgnore";
    private static final String SOMA_KEY = "io.github.somaruntime.soma.annotation.SomaKey";
    private static final String SOMA_CHILD = "io.github.somaruntime.soma.annotation.SomaChild";
    private static final String SOMA_OPTIONAL = "io.github.somaruntime.soma.annotation.SomaOptional";
