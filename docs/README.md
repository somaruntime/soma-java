...
- [SOMA 参考应用边界与 `soma-examples` 重构治理](temp/reference-application-boundary-and-examples-governance/README.md)：解除旧四场景与 SOMA 产品设计的所有权耦合，将 `soma-examples` 重构为两个独立参考应用的聚合边界，并在完整迁移 G0–G5 evidence 后原子退役旧场景。
