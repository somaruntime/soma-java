...
| S3 Group/ownership/ledger | satisfied | `515bf91`；Zulu 8 runtime-core、generated dense/keyed/access/child/breadth、DataFlow Slice A与public API Gate；stable slots、multi-schema/multi-instance、atomic attach rollback、implicit Group、GroupLedger/TableLedger、dataVersion、分层fault、all-member preflight/reverse release、same/cross Group/cross-schema/self alias与partial-acquire rollback | 不等于完整Runtime/Observation Metadata、Invocation ledger、S4–S10、scale qualification或release readiness |
| S4–S10 | pending | 必须按本文件顺序继续 | 不得用S1–S3结果关闭后续slice |
