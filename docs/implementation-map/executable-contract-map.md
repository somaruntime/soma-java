...
|---|---|---|
| annotation public API | [`com.hgtech.soma.annotation`](../../soma-annotations/src/main/java/com/hgtech/soma/annotation) | [`check-public-api.sh`](../../scripts/check-public-api.sh) 与 current public `javap` golden |
...
| handwritten runtime public API | [`com.hgtech.soma.runtime`](../../soma-runtime-core/src/main/java/com/hgtech/soma/runtime) | [`public-api/current/public-api.javap.txt`](../../tests/fixtures/public-api/current/public-api.javap.txt) |
...
| DataFlow public API | [`com.hgtech.soma.dataflow`](../../soma-dataflow/src/main/java/com/hgtech/soma/dataflow) 与 generated companion | public `javap`、capability contracts、external consumer、reference differential |
