...
import io.github.somaruntime.soma.benchmarks.schema.generated.NumericFactScan;
...
import io.github.somaruntime.soma.dataflow.DataFlowExplain;
...
import io.github.somaruntime.soma.dataflow.DeltaApplyResult;
...
import io.github.somaruntime.soma.dataflow.OpaqueLongFunction;
import io.github.somaruntime.soma.dataflow.OptionalLongColumnResult;
...
import io.github.somaruntime.soma.dataflow.RegisteredLongFunction;
import io.github.somaruntime.soma.dataflow.RegisteredLongReducer;
...
/**
 * Shape、visitor delivery、graph、registered function 与 diagnostics 能力契约。
 *
 ...
 */
public final class DataFlowShapeAndGraphContractCheck {
    private DataFlowShapeAndGraphContractCheck() {
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("dataflow-shape-and-graph-contract: ok");
    }
