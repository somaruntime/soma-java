...
import io.github.somaruntime.soma.dataflow.BooleanColumnResult;
...
import io.github.somaruntime.soma.dataflow.DoubleScalarResult;
...
/** Deterministic parallel execution、fallback 与 failure 能力契约。 */
public final class DataFlowExecutionContractCheck {
    private static final int ROWS = 8192;

    private DataFlowExecutionContractCheck() {
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("dataflow-execution-contract: ok");
    }
