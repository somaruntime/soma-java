...
import io.github.somaruntime.soma.benchmarks.schema.generated.GroupCandidateDelta;
...
import io.github.somaruntime.soma.benchmarks.schema.generated.OwnerFactDelta;
...
import io.github.somaruntime.soma.dataflow.DoubleColumnResult;
import io.github.somaruntime.soma.runtime.DeltaStagingFormula;
...
/** Single-source MutationSet 与 safe-point Effect 能力契约。 */
public final class DataFlowMutationContractCheck {
    private DataFlowMutationContractCheck() {
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("dataflow-mutation-contract: ok");
    }
