...
import io.github.somaruntime.soma.benchmarks.schema.generated.NumericFactCursor;
...
import io.github.somaruntime.soma.dataflow.BooleanScalarResult;
...
public final class DataFlowPointAndDeliveryContractCheck {
    ...
    public static void main(String[] args) {
        ...
        List<io.github.somaruntime.soma.benchmarks.schema.NumericFact> point =
                execute(
        ...
        List<io.github.somaruntime.soma.benchmarks.schema.NumericFact> materialized =
                execute(
                        source.materialize(
                                source.candidates()
                                        .filter(source.columns().factIndex()
