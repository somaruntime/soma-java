...
/** Selection、order、value、budget 与 current-Index differential 能力契约。 */
public final class DataFlowSelectionAndValueContractCheck {
    private static final double[] VALUES =
            new double[] {5.0d, 1.0d, 3.0d, 3.0d, 9.0d, 2.0d, 9.0d, 4.0d};

    private DataFlowSelectionAndValueContractCheck() {
    }
    ...
    public static void main(String[] args) {
        ...
        table.release();
        System.out.println("dataflow-selection-and-value-contract: ok");
    }
