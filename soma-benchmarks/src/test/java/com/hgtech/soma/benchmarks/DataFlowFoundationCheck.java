...
/** Generated v5 binding、aggregate guard 与 one-shot lifecycle 的窄验证。 */
public final class DataFlowFoundationCheck {
    private DataFlowFoundationCheck() {
    }
    ...
    public static void main(String[] args) {
        ...
        context.close();
        table.release();
        System.out.println("dataflow-foundation-check: ok");
    }
