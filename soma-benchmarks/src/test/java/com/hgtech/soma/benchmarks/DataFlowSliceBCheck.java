...
import com.hgtech.soma.dataflow.GroupIndexResult;
import com.hgtech.soma.dataflow.GroupedLongResult;
import com.hgtech.soma.dataflow.ExpandedIndexResult;
...
import com.hgtech.soma.dataflow.WindowIndexResult;
import com.hgtech.soma.runtime.IndexSnapshot;

/** Slice B 的 Partition/Combine、GroupBy、Join 与 finite Window reference evidence。 */
public final class DataFlowSliceBCheck {
    private DataFlowSliceBCheck() {
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("dataflow-slice-b-check: ok");
    }
