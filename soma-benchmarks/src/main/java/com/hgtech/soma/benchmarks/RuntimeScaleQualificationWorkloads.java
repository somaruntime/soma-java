...
import com.hgtech.soma.benchmarks.schema.ScaleNumericFact;
import com.hgtech.soma.benchmarks.schema.WorkKey;
import com.hgtech.soma.benchmarks.schema.generated.OwnerFactBatch;
import com.hgtech.soma.benchmarks.schema.generated.OwnerFactDataFlow;
...
import com.hgtech.soma.benchmarks.schema.generated.OwnedOptionDataFlow;
import com.hgtech.soma.benchmarks.schema.generated.ScaleNumericFactBatch;
import com.hgtech.soma.benchmarks.schema.generated.ScaleNumericFactDataFlow;
import com.hgtech.soma.benchmarks.schema.generated.ScaleNumericFactDelta;
import com.hgtech.soma.benchmarks.schema.generated.ScaleNumericFactScan;
import com.hgtech.soma.benchmarks.schema.generated.ScaleNumericFactTable;
import com.hgtech.soma.benchmarks.schema.generated.ScaleStringAccessFactBatch;
import com.hgtech.soma.benchmarks.schema.generated.ScaleStringAccessFactTable;
import com.hgtech.soma.benchmarks.schema.generated.ScaleStringFactBatch;
import com.hgtech.soma.benchmarks.schema.generated.ScaleStringFactCursor;
import com.hgtech.soma.benchmarks.schema.generated.ScaleStringFactDataFlow;
import com.hgtech.soma.benchmarks.schema.generated.ScaleStringFactScan;
import com.hgtech.soma.benchmarks.schema.generated.ScaleStringFactTable;
import com.hgtech.soma.benchmarks.schema.generated.SchemaMetadata;
...
import com.hgtech.soma.dataflow.ExpandedFlow;
...
final class RuntimeScaleQualificationWorkloads {
    ...
    private static QualificationObservation medium(
        ...
        result.observation = BenchmarkModel.object(
                ...
                "candidateFormula",
                com.hgtech.soma.dataflow.CandidatePhysicalFormula.IDENTITY,
                "relationFormula",
                com.hgtech.soma.dataflow.RelationStrategyFormula.IDENTITY);
        result.checksum = hex(checksum);
        result.limitations = BenchmarkModel.limitations(
                LOCAL_LIMITATION,
    ...
    private static QualificationObservation million(
        ...
        result.observation = BenchmarkModel.object(
                ...
                "deltaFormula",
                com.hgtech.soma.runtime.DeltaStagingFormula.IDENTITY);
        result.checksum = hex(checksum);
        result.limitations = BenchmarkModel.limitations(
                LOCAL_LIMITATION,
            ...
            CallbackDeliveryInvocation<ScaleNumericFactScan.Visitor>
                    invocation = source.deliver(
                            ...
                            .visitor(new ScaleNumericFactScan.Visitor() {
                                @Override
                                public boolean visit(
                                        com.hgtech.soma.benchmarks.schema
                                                .generated
                                                .ScaleNumericFactCursor row) {
                                    calls[0]++;
                                    return true;
    ...
    private static ExpansionProbe runSyntheticExpansion(
        ...
        ExpandedFlow<ProbeBinding, ProbeBinding> expanded =
                com.hgtech.soma.dataflow.GeneratedDataFlow.ownedChildren(
                        parent,
                        com.hgtech.soma.dataflow.GeneratedDataFlow
                                .candidates(parent),
                        child,
                        access);
        DataFlowContext context = DataFlowContext.sequential();
        DataFlowInvocation<
                com.hgtech.soma.dataflow.ExpandedIndexResult>
    ...
    private static final class ProbeBinding
        ...
        public String transformationProtocol() {
            return com.hgtech.soma.dataflow.GeneratedDataFlow
