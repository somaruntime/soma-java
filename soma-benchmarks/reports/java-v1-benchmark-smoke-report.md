...
> 当前性说明（2026-07-23）：本报告记录 2026-07-11 的 v2 benchmark artifact；旧 SparseInt、maintained-order、sidecar-rebuild 与旧场景 lanes 已被后续治理取代。当前 neutral component、应用 integrated lane 与重验证入口见[当前性能摘要](../../reports/current-performance-summary.md)和[参考应用边界治理报告](../../reports/2026-07-23-reference-application-boundary-governance-report.md)；本文只保留历史 evidence。
