...
> 当前性说明（2026-07-21）：本报告记录 2026-07-11 的 v2 benchmark artifact；旧 SparseInt、maintained-order、sidecar-rebuild 与旧场景 lanes 已被后续治理取代。当前 smoke manifest、exact/dense lane 映射与重验证入口见 [2026-07-21 四场景采纳报告](../../reports/2026-07-21-four-scenario-blueprint-adoption-report.md)；本文只保留历史 evidence。
